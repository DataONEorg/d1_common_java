...
public class GroupComparator implements Comparator {
  ...
  public int  compare(Object o1, Object o2) throws ClassCastException, NullPointerException {
    if(o1 == null || o2 == null) {
      throw new NullPointerException("GroupComparator.compare - the parameters of compare method can't be null.");
    }
    Group group1 = (Group) o1;
    Group group2 = (Group) o2;
    if(group1.getGroupName() == null || group2.getGroupName() == null ) {
      throw new NullPointerException("GroupComparator.compare - the group names of the Group objects can't be null.");
    }
  ...
  public boolean equals(Object obj) {
    if(obj instanceof GroupComparator ) {
      return true;
    } else {
      return false;
    }
