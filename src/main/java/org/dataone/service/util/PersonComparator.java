...
/**
 * A comparator for comparing the Person objects base on the family name.
 * @author tao
 *
 */
public class PersonComparator implements Comparator{
  ...
  public int  compare(Object o1, Object o2) throws ClassCastException, NullPointerException {
    if(o1 == null || o2 == null) {
      throw new NullPointerException("PersonComparator.compare - the parameters of compare method can't be null.");
    }
    Person person1 = (Person) o1;
    Person person2 = (Person) o2;
    if(person1.getFamilyName() == null || person2.getFamilyName() == null) {
      throw new NullPointerException("PersonComparator.compare - the family names of Person objects can't be null.");
    }
